...
from library import deepspeed_utils, model_util, sai_model_spec, save_utils, strategy_base
strategy_sd = type("strategy_sd", (), {"SdTokenizeStrategy": type("SdTokenizeStrategy", (), {}), "SdSdxlLatentsCachingStrategy": type("SdSdxlLatentsCachingStrategy", (), {}), "SdTextEncodingStrategy": type("SdTextEncodingStrategy", (), {})})
import copy
